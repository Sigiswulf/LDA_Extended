...
country = {
	...
	BASE_GREATPOWER_DAILY_INFLUENCE = 0.10, -- Influence value which is distributed each day
	...
	COLONIZATION_DAYS_BETWEEN_INVESTMENT = 100,
...
diplomacy = {
	...
	PEACE_COST_GUNBOAT = 200, -- Cost of forcing a defaulting country to pay its debt
...
pops = {
	...
	REBEL_OCCUPATION_STRENGTH_BONUS = 0.03, -- the amount of strength given to rebel movements when they occupy a province
...
ai =
{
	...
	AGGRESSION_BASE = 60, -- general AI aggression
	AGGRESSION_UNCIV_BONUS = 65, -- additional AI civ aggression against uncivs
